...
(function($){
    ...
    $.fn.smartCart.defaults = {
          ...
          productItemTemplate:'<strong><%=pname%></strong><br />Outlet: <%=pcategory%><br /><small><%=pdesc%></small><br /><strong>Price: <%=pprice%></strong>',
